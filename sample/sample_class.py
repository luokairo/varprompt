...
vae_ckpt, var_ckpt = '/fs/scratch/PAS2473/MM2025/neurpis2025/ckpt/var/vae_ch160v4096z32.pth', f'/fs/scratch/PAS2473/MM2025/neurpis2025/VAR/local_output_c2i/ar-ckpt-last.pth'
...
class_labels = (934, 980, 437, 437, 32, 32, 562, 562, 263, 31, 123, 73, 238, 212, 339, 101)   #@param {type:"raw"}
...
chw = chw.permute(1, 2, 0).mul_(255).clamp(0, 255).byte().cpu().numpy()
